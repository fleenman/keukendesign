...
<template>
  ...
  <ContentSection dark title="Bespreek uw eigen ruimte" text="Neem plattegrond, foto's of ideeën mee. In de showroom worden materialen, systemen en indelingen concreet.">
    <ContactActions />
  </ContentSection>
</template>
