...
footerGroups:
  - title: Afspraak
    links:
      - label: Maak een afspraak
        to: /contact/
      - label: Showroom bezoeken
        to: /showroom/
      - label: Route en parkeren
        to: /showroom/route-en-parkeren/
  ...
  - title: Inspiratie
    links:
      - label: Projecten
        to: /projecten/
      - label: Keukens Amersfoort
        to: /keukens-amersfoort/
  - title: Advies
    links:
      - label: Werkwijze
        to: /advies/werkwijze/
  ...
  - title: Juridisch
    links:
      - label: Privacy
        to: /privacy/
      - label: Admin
        href: https://jleenman.github.io/keukendesign/admin/
---
Sitebrede instellingen voor de Nuxt website en het CMS.
